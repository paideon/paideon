...
export function YouTubeInlineColor({
  size = "md",
  color,
  className,
  style,
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M0,0 L5,2 L30,16 L47,26 L73,41 L99,56 L107,61 L104,64 L78,79 L52,94 L28,108 L2,123 L0,123 Z "
        fill={color || "#FFFBFC"}
        transform="translate(368,224)"
      />
    </svg>
  );
}
