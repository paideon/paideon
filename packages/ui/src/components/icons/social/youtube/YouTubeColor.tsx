...
export function YouTubeColor({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M0,0 L6,2 L32,17 L56,31 L84,47 L108,61 L134,76 L160,91 L186,106 L212,121 L214,122 L214,124 L186,140 L162,154 L136,169 L112,183 L86,198 L62,212 L36,227 L12,241 L2,247 L0,247 Z "
        fill={color || "#FFFEFE"}
        transform="translate(545,414)"
      />
    </svg>
  );
}
